...
public class ImportFromXmlException extends Exception {
	...
	public static final String REASON_NOT_VALID_EXCEL = "Not a valid xml file.";
	
	private String reason;
	private File file;
	
	
	public ImportFromXmlException(final Throwable t) {
		super(t);
	}
	
	public ImportFromXmlException(final File file, final String reason) {
		this.file = file;
		this.reason = reason;
	}
