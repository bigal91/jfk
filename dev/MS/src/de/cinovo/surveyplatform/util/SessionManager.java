 ...
 * <br>
 * 
 * Manager for {@link HttpSession} objects. Stores the sessions in a
 * {@link HashMap} with the users name as key. One user may have multiple
 * Sessions.<br>
 * <i>Hint: This class is implemented as singleton and so will not deliver
 * consistent results when used in a clustered/distributed system!</i>
 * 
 * @author yschubert
 * 
 */
